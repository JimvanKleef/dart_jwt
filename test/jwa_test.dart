...
void main() {
  ...
  RSAPublicKey _pkcs1PublicKey(String keyString) {
    var key_bytes = new Uint8List.fromList(CryptoUtils.base64StringToBytes(keyString));
    var p = new ASN1Parser(key_bytes);
    ASN1Sequence seq = p.nextObject();
    var modulus = (seq.elements[0] as ASN1Integer).intValue;
    var publicExponent = new BigInteger((seq.elements[1] as ASN1Integer).intValue);
  ...
  RSAPrivateKey _pkcs1PrivateKey(String keyString) {
    ...
    var privateExponent = (seq.elements[3] as ASN1Integer).intValue;
    var prime1 = (seq.elements[4] as ASN1Integer).intValue;
    var prime2 = (seq.elements[5] as ASN1Integer).intValue;
    RSAPrivateKey key = new RSAPrivateKey(modulus, privateExponent, prime1, prime2);
    return key;
  }
...
''';
    ...
    test('simple', () {
      ...
      'OiJhZG1pbiIsImF1ZCI6ImZvb2JhciJ9', rsaPrivateKey),
...
''';
    ...
    test('validate', () {
      Uint8List signatureBytes = new Uint8List.fromList([
          ,
